...
import {IconArrowBack, IconBrandGithub, IconBrandGoogle, IconBrandOpenai} from "@tabler/icons-react";
...
export default function Login({
  ...
  const signIn = async (formData: FormData) => {
    ...
    const { data, error } = await supabase.auth.signInWithOAuth({
      provider:provider,
      options: { redirectTo: `http://${headersList.get('host')}/auth/callback` },
    })
